...
def hd_analysis(op_config, hd_config, V_AMP_IN=0.632, FIN=10.35e6, F_SPACING=1e6):
    """
    ...
    # =================================================================
    GND = -1 # AC 地的約定索引
    hd_probes = hd_config.get('hd_probes', [])
    # op_config['hd_probes'] = {
    #     'input': {'p': 'inp', 'n': 'inn'},
    #     'output': {'p': 'p2', 'n': 'n2'}
    # }
    ...
    fixed_voltages_to_exclude = hd_config.get('fixed_voltages', [])
    ...
    def calc_iNL2(K, vg, vd, mos_type):
        ...
        return -i_nl2 if mos_type == 'PMOS' else i_nl2
    ...
    def calc_iNL3(K, vg1, vd1, vg2, vd2, mos_type):
        ...
        if mos_type == 'PMOS': return i_pure3 - i_mix
    ...
    def calc_iNL3_imd3(K, va, vda, vb_c, vdb_c, v2a, vd2a, vdw, vddw, mos_type):
        ...
        return i_pure3 - i_mix if mos_type == 'PMOS' else i_pure3 + i_mix
...
if __name__ == "__main__":
    ...
    # test_op_config = {
    #     # 修正節點名稱：將 'P1' 改為 'N_P1' 以匹配元件定義，否則 'P1' 行將為全零導致矩陣奇異
    #     'all_nodes': ['inp', 'inn', 'N_P1', 'N_N1', 'N_S', 'N_1', 'N_2', 'N_3', 'p2', 'n2', 'N_4', 'mid1', 'mid2', 'VDD', 'VCM', '0'],
    #     'mosfets': {
    #         'M1':  {'d': 'N_1', 'g': 'N_P1', 's': 'N_S', 'b': 'N_S', 'VGS': 0.2565, 'VDS': 0.4191, 'W': 96e-6, 'L': 100e-9, 'model': nch_lvt, 'type_inl': 'NMOS'},
    #         'M2':  {'d': 'N_2', 'g': 'N_N1', 's': 'N_S', 'b': 'N_S', 'VGS': 0.2565, 'VDS': 0.4191, 'W': 96e-6, 'L': 100e-9, 'model': nch_lvt, 'type_inl': 'NMOS'},
    #         'M3':  {'d': 'N_1', 'g': 'N_3', 's': 'VDD', 'b': 'VDD', 'VGS': 0.2873, 'VDS': 0.2873, 'W': 96e-6, 'L': 100e-9, 'model': pch, 'type_inl': 'PMOS'},
    #         'M4':  {'d': 'N_2', 'g': 'N_3', 's': 'VDD', 'b': 'VDD', 'VGS': 0.2873, 'VDS': 0.2873, 'W': 96e-6, 'L': 100e-9, 'model': pch, 'type_inl': 'PMOS'},
    #         'M5':  {'d': 'p2', 'g': 'N_1', 's': 'VDD', 'b': 'VDD', 'VGS': 0.2873, 'VDS': 0.4498, 'W': 192e-6,'L': 100e-9, 'model': pch, 'type_inl': 'PMOS'},
    #         'M6':  {'d': 'n2', 'g': 'N_2', 's': 'VDD', 'b': 'VDD', 'VGS': 0.2873, 'VDS': 0.4498, 'W': 192e-6,'L': 100e-9, 'model': pch, 'type_inl': 'PMOS'},
    #         'M7':  {'d': 'p2', 'g': 'N_4', 's': '0', 'b': '0', 'VGS': 0.3301, 'VDS': 0.4502, 'W': 48e-6, 'L': 100e-9, 'model': nch, 'type_inl': 'NMOS'},
    #         'M8':  {'d': 'n2', 'g': 'N_4', 's': '0', 'b': '0', 'VGS': 0.3301, 'VDS': 0.4502, 'W': 48e-6, 'L': 100e-9, 'model': nch, 'type_inl': 'NMOS'},
    #         'M10': {'d': 'N_S', 'g': 'VCM', 's': '0', 'b': '0', 'VGS': 0.4585, 'VDS': 0.1936, 'W': 32e-6, 'L': 500e-9, 'model': nch, 'type_inl': 'NMOS'},
    #     },
    #     'R': {
    ...
    #     'mosfets': {
    #         'M1':  {'d': 'N_1', 'g': 'N_P1', 's': 'N_S', 'b': 'N_S', 'VGS': 0.26023252464408414, 'VDS': 0.4186290749436615, 'W': 96e-6, 'L': 100e-9, 'model': nch_lvt, 'type_inl': 'NMOS'},
    #         'M2':  {'d': 'N_2', 'g': 'N_N1', 's': 'N_S', 'b': 'N_S', 'VGS': 0.26023252464408414, 'VDS': 0.4186290749436615, 'W': 96e-6, 'L': 100e-9, 'model': nch_lvt, 'type_inl': 'NMOS'},
    #         'M3':  {'d': 'N_1', 'g': 'N_3', 's': 'VDD', 'b': 'VDD', 'VGS': 0.2916034497004226, 'VDS': 0.2916034497004226, 'W': 96e-6, 'L': 100e-9, 'model': pch, 'type_inl': 'PMOS'},
    #         'M4':  {'d': 'N_2', 'g': 'N_3', 's': 'VDD', 'b': 'VDD', 'VGS': 0.2916034497004226, 'VDS': 0.2916034497004226, 'W': 96e-6, 'L': 100e-9, 'model': pch, 'type_inl': 'PMOS'},
    #         'M5':  {'d': 'p2', 'g': 'N_1', 's': 'VDD', 'b': 'VDD', 'VGS': 0.2916034497004226, 'VDS': 0.45, 'W': 192e-6,'L': 100e-9, 'model': pch, 'type_inl': 'PMOS'},
    #         'M6':  {'d': 'n2', 'g': 'N_2', 's': 'VDD', 'b': 'VDD', 'VGS': 0.2916034497004226, 'VDS': 0.45, 'W': 192e-6,'L': 100e-9, 'model': pch, 'type_inl': 'PMOS'},
    #         'M7':  {'d': 'p2', 'g': 'N_4', 's': '0', 'b': '0', 'VGS': 0.3274463027457281, 'VDS': 0.45, 'W': 48e-6, 'L': 100e-9, 'model': nch, 'type_inl': 'NMOS'},
    #         'M8':  {'d': 'n2', 'g': 'N_4', 's': '0', 'b': '0', 'VGS': 0.3274463027457281, 'VDS': 0.45, 'W': 48e-6, 'L': 100e-9, 'model': nch, 'type_inl': 'NMOS'},
    #         'M10': {'d': 'N_S', 'g': 'VBN', 's': '0', 'b': '0', 'VGS': 0.45851571188365686, 'VDS': 0.18976747535591587, 'W': 32e-6, 'L': 500e-9, 'model': nch, 'type_inl': 'NMOS'},
    #     },
    #     'R': {
    #         'R_f_p': {'p': 'N_P1', 'n': 'n2', 'val': 4000},
    #         'R_f_n': {'p': 'N_N1', 'n': 'p2', 'val': 4000},
    #         'R_in_p': {'p': 'N_P1', 'n': 'inp', 'val': 4000},
    #         'R_in_n': {'p': 'N_N1', 'n': 'inn', 'val': 4000},
    #         'R_cmfb_p2_4': {'p': 'p2', 'n': 'N_4', 'val': 40.51e3},
    #         'R_cmfb_n2_4': {'p': 'n2', 'n': 'N_4', 'val': 40.51e3},
    #         'R_cmfb_1_3': {'p': 'N_1', 'n': 'N_3', 'val': 40.51e3},
    #         'R_cmfb_2_3': {'p': 'N_2', 'n': 'N_3', 'val': 40.51e3},
    #         'Rz1': {'p': 'mid1', 'n': 'N_1', 'val': 204.6},
    #         'Rz2': {'p': 'mid2', 'n': 'N_2', 'val': 204.6},
    #     },
    #     'C': {
    ...
    test_params = {
        'all_nodes': {'0', '1', '2', '3', '4', 'VBN', 'VDD', 'inn', 'inp', 'n1', 'n2', 'net16', 'net19', 'p1', 'p2', 's'},
        'mosfets': {
            'M0': {'L': 5e-07, 'VDS': 0.45851571188365686, 'VGS': 0.45851571188365686, 'W': 3.2e-05, 'b': '0', 'd': 'VBN', 'g': 'VBN', 'model': nch, 's': '0', 'type_inl': 'NMOS'},
            'M1': {'L': 1e-07, 'VDS': 0.4186290749436615, 'VGS': 0.26023252464408414, 'W': 9.6e-05, 'b': 's', 'd': '1', 'g': 'p1', 'model': nch_lvt, 's': 's', 'type_inl': 'NMOS'},
            'M2': {'L': 1e-07, 'VDS': 0.4186290749436615, 'VGS': 0.26023252464408414, 'W': 9.6e-05, 'b': 's', 'd': '2', 'g': 'n1', 'model': nch_lvt, 's': 's', 'type_inl': 'NMOS'},
            'M3': {'L': 1e-07, 'VDS': 0.2916034497004226, 'VGS': 0.2916034497004226,  'W': 9.6e-05, 'b': 'VDD', 'd': '1', 'g': '3', 'model': pch, 's': 'VDD', 'type_inl': 'PMOS'},
            'M4': {'L': 1e-07, 'VDS': 0.2916034497004226, 'VGS': 0.2916034497004226,  'W': 9.6e-05, 'b': 'VDD', 'd': '2', 'g': '3', 'model': pch, 's': 'VDD', 'type_inl': 'PMOS'},
            'M5': {'L': 1e-07, 'VDS': 0.45, 'VGS': 0.2916034497004226, 'W': 0.000192, 'b': 'VDD', 'd': 'p2', 'g': '1', 'model': pch, 's': 'VDD', 'type_inl': 'PMOS'},
            'M6': {'L': 1e-07, 'VDS': 0.45, 'VGS': 0.2916034497004226, 'W': 0.000192, 'b': 'VDD', 'd': 'n2', 'g': '2', 'model': pch, 's': 'VDD', 'type_inl': 'PMOS'},
            'M7': {'L': 1e-07, 'VDS': 0.45, 'VGS': 0.3274463027457281, 'W': 4.8e-05, 'b': '0', 'd': 'p2', 'g': '4', 'model': nch, 's': '0', 'type_inl': 'NMOS'},
            'M8': {'L': 1e-07, 'VDS': 0.45, 'VGS': 0.3274463027457281, 'W': 4.8e-05, 'b': '0', 'd': 'n2', 'g': '4', 'model': nch, 's': '0', 'type_inl': 'NMOS'},
            'M10': {'L': 5e-07,'VDS': 0.18976747535591587, 'VGS': 0.45851571188365686, 'W': 3.2e-05, 'b': '0', 'd': 's', 'g': 'VBN', 'model': nch, 's': '0','type_inl': 'NMOS'}
        },
        'R': {
            'R34': {'n': 'n2', 'p': 'p1', 'val': 4000.0},
            'R35': {'n': 'p2', 'p': 'n1', 'val': 4000.0},
            'R36': {'n': 'n1', 'p': 'inn', 'val': 4000.0},
            'R37': {'n': 'p1', 'p': 'inp', 'val': 4000.0},
            'R38': {'n': '4', 'p': 'p2', 'val': 40510.0},
            'R39': {'n': '3', 'p': '1', 'val': 40510.0},
            'R40': {'n': '3', 'p': '2', 'val': 40510.0},
            'R41': {'n': '4', 'p': 'n2', 'val': 40510.0},
            'R42': {'n': '1', 'p': 'net19', 'val': 204.6},
            'R43': {'n': '2', 'p': 'net16', 'val': 204.6}
        },
        'C': {
            'C0': {'n': 'net19', 'p': 'p2', 'val': 4.02e-13},
            'C1': {'n': 'net16', 'p': 'n2', 'val': 4.02e-13}
        },
    }
    ...
    # output = f"test_params = {pformat(op_config, indent=4)}"
    # print(output)

    metrics = hd_analysis(op_config, config['hd'], V_AMP_IN=0.316, FIN=53/512*100e6)
